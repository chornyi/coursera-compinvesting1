...
def main():
    orders = read_orders('quiz_orders2.csv')
    print 'Read ORDERS: ' + '\n' + str(orders) + '\n'
    ...
    cash = calculate_cash(orders, market_data, 1000000)
    print 'Cash (excerpt): ' + '\n' + str(cash[0: 10]) + '\n'
    ...
    datetime = dt.datetime.strptime('Dec 6 2011  4:00PM', '%b %d %Y %I:%M%p')
    amount = get_amount_on(portfolio_plus_cash, datetime)
    print 'Amount on ' + str(datetime) + ' : ' + str(amount)
